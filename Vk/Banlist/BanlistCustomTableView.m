//
//  BanlistCustomTableView.m
//  MasterAPI
//
//  Created by sim on 30.10.16.
//  Copyright © 2016 sim. All rights reserved.
//

#import "BanlistCustomTableView.h"

@implementation BanlistCustomTableView
...
- (IBAction)openUserInfoInBrowser:(id)sender{
    ...
    [[NSNotificationCenter defaultCenter] postNotificationName:@"VisitUserPageFromBanlist" object:self userInfo:@{@"row":[NSNumber numberWithInteger:_row]}];
}
